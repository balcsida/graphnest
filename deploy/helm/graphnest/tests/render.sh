...
reject 'GRAPHNEST_SUPPLY_CHAIN' "$tmp/minimal.yaml"
require 'GRAPHNEST_SUPPLY_CHAIN: "true"' "$tmp/optional.yaml"
require 'GRAPHNEST_SUPPLY_CHAIN_INTERVAL: "12h"' "$tmp/optional.yaml"
