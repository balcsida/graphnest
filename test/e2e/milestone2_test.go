...
func TestMilestone2Vertical(t *testing.T) {
	...
	httpapi.RegisterSearch(mux, requestAuthenticator, searchService, 64<<10, 256<<10)
	httpapi.RegisterRepositories(mux, requestAuthenticator, repositoryService, 64<<10, 100, 256<<10)
