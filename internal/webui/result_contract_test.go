...
func TestConsoleBoundsLongRepositoryLabels(t *testing.T) {
	for _, want := range []string{
		...
		`fieldset label{display:flex;gap:8px;align-items:center;min-width:0;min-height:30px;padding:0 6px;border-radius:6px;overflow-wrap:anywhere;font-size:13px}`,
