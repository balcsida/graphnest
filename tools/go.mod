module github.com/balcsida/graphnest/tools
...
require (
	...
	github.com/sourcegraph/mountinfo v0.0.0-20251117172727-e9f6a87f579c // indirect
	github.com/sourcegraph/zoekt v0.0.0-20260717095332-3c8b39b1ef4f // indirect
